...
# ---------------------------------------------------------------------------
# NER-style Named Entity patterns (rule-based)
# ---------------------------------------------------------------------------
...
def scan_document(text: str, keywords_list: list, include_pii: bool = True, include_ner: bool = True) -> list:
    results = []
    ...
    # User-defined keyword scanning with fuzzy matching
